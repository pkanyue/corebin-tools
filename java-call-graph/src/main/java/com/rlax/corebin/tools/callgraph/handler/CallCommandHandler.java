...
public interface CallCommandHandler {
     ...
     * @param callOrder 调用序号
     * @return 调用信息
     */
    MethodCallInfo handle(JavaClass callerJavaClass, Method callerMethod, InstructionHandle instructionHandle, String callOrder);
     ...
     * @return 调用信息
     */
    MethodCallInfo handleCallCommand(JavaClass callerJavaClass, Method callerMethod, InstructionHandle instructionHandle, CallType callType, String callOrder);
